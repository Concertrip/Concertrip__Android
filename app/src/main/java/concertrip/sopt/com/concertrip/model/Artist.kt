...
data class Artist(
    ...
    var memberList : List<Artist>?, // added >> have to fix constructors
    ...
    constructor(_id : String,  profileImg : String,backImg: String?,name  :String, genre:String,youtubeUrl:String,subscribeNum :Int,memberList: List<Artist>?, concertList: List<Concert>)
            : this(_id,profileImg,null,name,genre,youtubeUrl,subscribeNum, listOf(), listOf(),false)
    constructor(_id : String, name  :String, profileImg : String) : this(_id,profileImg,null,name,null,null,0, listOf(),listOf(), false)
