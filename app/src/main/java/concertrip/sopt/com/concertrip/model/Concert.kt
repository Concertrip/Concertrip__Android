...
//            list.add(Concert.getDummy_2(3.toString()))
        ...
        fun getDummy(_id : String)= Concert(_id = _id, title = "힙합 페스티발", genre = "힙합", youtubeUrl = "IA1hox-v0jQ",backImg = "https://img.huffingtonpost.com/asset/5ba482b82400003100546bc3.jpeg",
            ...
            seatList = listOf(Seat("R", 80000), Seat("VIP", 120000)), precaution = ArrayList<Caution>(), subscribeNum = 0, subscribe = false)
...
//            seatList = listOf(Seat("R", "80,000"), Seat("VIP", "120,000")),  precaution = ArrayList<Caution>(),  subscribeNum = 0, subscribe = false)
//
